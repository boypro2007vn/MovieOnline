 ...
 * @author ASUS
 */
@WebServlet(name = "AdminPaymentListServlet", urlPatterns = {"/AdminPaymentList"})
public class AdminPaymentListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("list", accountVipHistoryFacade.findAll());
        request.getRequestDispatcher("admin_page/admin_payment_list.jsp").forward(request, response);
    }
